...
namespace functions
{
	...
	*/
	...
	constexpr uint32_t return_to_cs_player_setup_bones = 0x3e84c6; // WARNING: CAN BE VERY WRONG // 0x3E84C6; // IDA: "84 C0 75 0D F6 87 28 0A 00 00 0A"
...
namespace offsets
{
	...
	namespace base_csgrenade_projectile
	{
		...
		constexpr uint32_t fn_post_data_update = 0x3CC380; // 55 8B EC 83 EC 0C 56 57 8B 7D 08 8B F1 57 ������� ��� ���
	}
